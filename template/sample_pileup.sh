...
bwa mem -M -t 4 $BWA_DB $s_S1_R1 $s_S1_R2 > s_bwa.sam
bowtie2 -p 4 -k 5 -x $BOWTIE2_DB -1 $s_S1_R1 -2 $s_S1_R2 -S s_bowtie2.sam


samtools view -q 10 -bS s_bwa.sam > s_bwa.bam
samtools view -q 10 -bS s_bowtie2.sam > s_bowtie2.bam
