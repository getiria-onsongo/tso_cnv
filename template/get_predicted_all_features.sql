DROP TABLE IF EXISTS sample_name_predicted_all_features;
CREATE TABLE sample_name_predicted_all_features AS
...
sample_name_data A
JOIN
sample_name_prediction_all_features B
USING(window_id)) A1
JOIN
tso_exon_60bp_segments_window_data B1
USING(window_id);
SELECT * FROM sample_name_predicted_all_features;
