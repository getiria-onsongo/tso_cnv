...
samtools mpileup -f $S_DB -d 10000 -q 1 bwa.fixed.bam | cut -f 1,2,4 > cnv_control_name_bwa_pileup.txt
samtools mpileup -f $S_DB -d 10000 -q 1 bwa.fixed_nodup.bam | cut -f 1,2,4 > cnv_control_name_bwa_pileup_no_dup.txt
samtools mpileup -f $S_DB -d 10000 -q 1 bowtie2.fixed.bam | cut -f 1,2,4 > cnv_control_name_bowtie2_pileup.txt
