...
bwa mem -M -t 4 $BWA_DB $c_S1_R1 $c_S1_R2 > c_bwa.sam
bowtie2 -p 4 -k 5 -x $BOWTIE2_DB -1 $c_S1_R1 -2 $c_S1_R2 -S c_bowtie2.sam

samtools view -q 10 -bS c_bwa.sam > c_bwa.bam
samtools view -q 10 -bS c_bowtie2.sam > c_bowtie2.bam
