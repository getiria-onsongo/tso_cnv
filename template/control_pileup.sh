...
bwa mem -M -t 4 $BWA_DB $c_S1_R1 $c_S1_R2 > c_bwa_s1.sam
bwa mem -M -t 4 $BWA_DB $c_S2_R1 $c_S2_R2 > c_bwa_s2.sam
bowtie2 -p 4 -k 5 -x $BOWTIE2_DB -1 $c_S1_R1 -2 $c_S1_R2 -S c_bowtie2_s1.sam
bowtie2 -p 4 -k 5 -x $BOWTIE2_DB -1 $c_S2_R1 -2 $c_S2_R2 -S c_bowtie2_s2.sam
